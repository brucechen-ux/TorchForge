...
def render_svg(
    ...
    *,
    ...
    elements = [
        ...
        f'<text x="{left}" y="70" font-family="Arial, sans-serif" font-size="14" fill="#52606D">Metric: {escape(metric)}; trailing smoothing window: {smooth_window}; x-axis: cumulative training tokens</text>',
    ]
